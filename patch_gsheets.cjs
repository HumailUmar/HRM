...
export class GoogleSheetsAdapter implements IDataAdapter {
  ...
  async saveEmployees(employees: Employee[]): Promise<void> {
    try {
      ...
      await this.localFallback.saveEmployees(employees);
    }
  }
  ...
  async saveAttendance(records: AttendanceRecord[]): Promise<void> {
    try {
      ...
      await this.localFallback.saveAttendance(records);
    }
  }
  ...
  async savePayroll(records: PayrollRecord[]): Promise<void> {
    try {
      ...
      await this.localFallback.savePayroll(records);
    }
  }
  ...
  async saveLeaves(records: LeaveRecord[]): Promise<void> {
    try {
      ...
      await this.localFallback.saveLeaves(records);
    }
  }
  ...
  async saveDepartments(depts: Department[]): Promise<void> {
    try {
      ...
      await this.localFallback.saveDepartments([depts[0]]);
    }
  }
  ...
  async saveDesignations(designations: Designation[]): Promise<void> {
    try {
      ...
      // Local fallback doesn't have saveDesignations
    }
  }
  ...
  async saveEmployeeDocuments(docs: EmployeeDocument[]): Promise<void> {
    try {
      ...
      await this.localFallback.saveDocument(docs[0]);
    }
  }
